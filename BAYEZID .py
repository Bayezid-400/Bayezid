...
def helpnote():
	...
	subprocess.check_output(["am", "start", https://www.facebook.com/md.bayezid.bostami.737"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/Bayezid-400/main/Approval.txt').text
			if basesplit in plr:
				key = basesplit
...
| $$  \ $$| $$  | $$    | $$    | $$        /$$/      | $$  | $$  | $$      
| $$$$$$$/| $$  | $$    | $$    | $$$$$$$$ /$$$$$$$$ /$$$$$$| $$$$$$$/      
|_______/ |__/  |__/    |__/    |________/|________/|______/|_______/       
                                                                            
                                                                            
                                                                            

\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;91m➣ \033[1;92mFACEBOOK   :            Bayezid 
     \033[1;93m➣ \033[1;92mWHATSAPP   :            01326226582
     \033[1;96m➣ \033[1;92mGITHUB     :            Bayezid-400  
